...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void createNotValidData() throws Exception {
        UserTo newTo = new UserTo(null, null, null, "12", 5);
    ...
    void createDuplicateEmail() throws Exception {
        UserTo newTo = new UserTo(null, "newName", user.getEmail(), "newPassword", 5000);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(newTo)))
                .andDo(print())
    ...
    void update() throws Exception {
        UserTo updatedTo = new UserTo(null, "newName", "update@yandex.ru", "newPassword", 1500);
    ...
    void updateDuplicateEmail() throws Exception {
        UserTo updatedTo = new UserTo(null, "newName", admin.getEmail(), "newPassword", 5000);
        perform(MockMvcRequestBuilders.put(REST_URL).contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(user))
                .content(JsonUtil.writeValue(updatedTo)))
                .andDo(print())
